...
const {headingInfo, saveId, setAnchorsProcessed} = require('../utils');
...
function anchors(md, {extractTitleOption, path, log}) {
    const plugin = (state) => {
        ...
        while (i < tokens.length) {
            ...
            /* Save the IDs that will be processed by the markdown-it-attrs plugin */
