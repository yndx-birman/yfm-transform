...
function transform(originInput, opts = {}) {
    const {
        ...
        allowHTML = false, linkify = false, breaks = true, conditionsInCode = false, substitutions = true,
    ...
    const input = liquid(originInput, vars, path, {conditionsInCode, substitutions});
